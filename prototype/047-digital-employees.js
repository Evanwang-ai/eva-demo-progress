...
function save(){run(()=>{
  ...
  if(type==='mine'){
    ...
    store.saveDraft(type,defaults());setType(null);navigatePersonal(a.id,navigate);Toast.success('已创建，已放入个人 Eva 同学');return;
  }
