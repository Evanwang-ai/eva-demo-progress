(function (root) {
  ...
  root.__evaPatch('sidebar', function (source) {
        ...
        var sidebarWidthReplacements = [
          ...
          [
            'SiderToolbar=({isMobile:rt,isBatchMode:ct,collapsed:ut,siderTooltipProps:pt,onNewChat:mt,onToggleBatchMode:gt})=>',
            'SiderToolbar=({isMobile:rt,isBatchMode:ct,collapsed:ut,siderTooltipProps:pt,onNewChat:mt,onToggleBatchMode:gt,isActive:st=!1})=>'
          ],
          [
            'className:classNames("w-full h-34px flex items-center justify-center cursor-pointer transition-colors text-t-primary rd-8px hover:bg-fill-3 active:bg-fill-4",siderStyles.newChatTrigger)',
            'className:classNames("w-full h-34px flex items-center justify-center cursor-pointer transition-colors text-t-primary rd-8px hover:bg-fill-3 active:bg-fill-4",siderStyles.newChatTrigger,st&&"bg-fill-3")'
          ],
          [
            'className:classNames(siderStyles.newChatTrigger,"h-34px flex-1 flex items-center justify-start gap-8px ps-10px pe-8px rd-0.5rem cursor-pointer group transition-all bg-transparent text-t-primary hover:bg-fill-3 active:bg-fill-4",rt&&"sider-action-btn-mobile")',
            'className:classNames(siderStyles.newChatTrigger,"h-34px flex-1 flex items-center justify-start gap-8px ps-10px pe-8px rd-0.5rem cursor-pointer group transition-all text-t-primary hover:bg-fill-3 active:bg-fill-4",st?"bg-fill-3":"bg-transparent",rt&&"sider-action-btn-mobile")'
          ]
        ];
...
`;
        ...
        source = root.__evaCutAll(source, [
          ...
          ['React.createElement(Route,{path:"/messages",element:withRouteFallback(MessagesPage$1)}),React.createElement(Route,{path:"/eva-stub/:name"', 'React.createElement(Route,{path:"/messages",element:withRouteFallback(MessagesPage$1)}),React.createElement(Route,{path:"/contacts",element:React.createElement(EvaNativePage,{pageId:"contacts"})}),React.createElement(Route,{path:"/drive",element:React.createElement(EvaNativePage,{pageId:"drive"})}),React.createElement(Route,{path:"/overview",element:React.createElement(EvaNativePage,{pageId:"overview"})}),React.createElement(Route,{path:"/eva-stub/:name"'],
